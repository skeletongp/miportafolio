<div>
    <div class="max-w-6xl px-10  py-6  mx-auto rounded-lg shadow-md mt-4 bg-blue-100 bg-opacity-40">
        ...
        <div>
            <div >
                <span class="flex items-center ">
                    ...
                    <h1 class="font-bold text-gray-700 select-none text-lg">{{ $post->autor->name }}</h1>
                    <div class="ml-auto ">
                        <small class="text-right ml-auto text-lg"> <span class="fas fa-eye text-green-500"></span><span class="bg-gray-100 px-2 rounded-xl">{{$views}}</span></small>
                    <small class="text-right ml-auto text-lg"> 
                        <span class="fas fa-thumbs-up text-blue-500 {{$is_liked?'text-gray  -500 ':'text-blue-500  cursor-pointer'}}" wire:click="{{$is_liked?'':'like'}}">
                        </span>
            ...
            <div class="mt-2  lg:max-h-96 lg:overflow-auto">
                <span id="span-content" class="mt-2 text-gray-900">{!! str_replace('http:','https:', $post->description) !!}</span>
            </div> 
            <div class="lg:flex-1 items-center justify-between mt-4 text-md sm:text-lg">
