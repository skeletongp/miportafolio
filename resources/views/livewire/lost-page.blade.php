<div>
    <!-- component -->
        ...
        <div class="">
            <div class="w-11/12 lg:w-9/12 m-auto  py-16 min-h-screen flex items-center justify-center">
                <div class="bg-white shadow-xl overflow-hidden rounded-xl pb-8 px-8">
                    <div class="border-t border-gray-200 text-center pt-8">
                        ...
                        <a href="{{ route('home') }}"
                            class="bg-gray-900 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md ">
                           HOME
                        </a>
