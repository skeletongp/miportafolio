<x-app-layout>
    ...
    <div class="pt-16 lg:pt-24 space-y-2 h-full flex-1 flex-1 justify-center w-full">
        <div class="max-w-screen-2xl mx-auto shadow pb-8">
            <form action="{{ route('project_edit',['project'=>$project]) }}" method="POST" class="p-4 lg:p-8" enctype="multipart/form-data"
                ...
                <div class="lg:flex">
                    <div class="space-y-2 lg:w-2/3 lg:mx-2 mb-4 lg:mb-1">
                        ...
                        <x-jet-input type="text" name="shortname" id="shortname" class="w-full" maxlength="100" value="{{old('shortname', $project->shortname)}}"></x-jet-input>
                    ...
                    <div class="space-y-2 lg:w-1/3 lg:mx-2 mb-4 lg:mb-1">
                        ...
                        <x-jet-input type="text" name="slug" id="slug" class="w-full" readonly value="{{old('slug', $project->slug)}}"></x-jet-input>
                ...
                <div class="mt-3 lg:mx-2 mb-4 lg:mb-4">
                    ...
                    <textarea class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full" name="longname">{{old('longname', $project->longname)}}</textarea>
                ...
                <div class="mt-3 lg:mx-2 mb-4 lg:mb-4">
                    ...
                    <textarea class="ckeditor form-control" name="description">{{old('description', $project->description)}}</textarea>
                ...
                <div class="lg:flex">
                    ...
                    <div class="space-y-2 lg:w-2/4 lg:mx-2 mb-4 lg:mb-1">
                        ...
                        <x-jet-input type="text" name="link" id="link" class="w-full" maxlength="100" value="{{old('link', $project->link)}}"></x-jet-input>
